    ...
    <main class="flex-1 bg-gray-100 p-4 sm:p-6 overflow-y-auto">
        <div id="content" class="transition-transform duration-500 ease-in-out">
            <div class="text-left mb-4 mr-16 pl-12">
                <!-- Form Tambah Konten Sejarah  (Opsional => jika belum ada)-->
                <form action="{{ route('admin.store-sejarah') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="mb-4">
                        <label for="foto_konten_sejarah" class="block text-gray-700 text-md font-bold mb-2">Gambar Sejarah
                        </label>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="isi_sejarah" id="isi_sejarah" class="summernote"></textarea>
                    </div>
