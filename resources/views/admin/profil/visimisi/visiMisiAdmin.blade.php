    ...
    <div class="flex h-screen overflow-hidden">
      ...
      >
        ...
        <main class="flex-1 bg-gray-100 p-4 sm:p-6">
          ...
          >
            <h1
              class="text-3xl sm:text-4xl font-bold text-indigo-900 mb-6 mt-4 sm:mt-8"
            >
              Visi
            </h1>
            <!--konten visi -->
            ...
            <p
              class="text-gray-800 mt-4 sm:mt-6 leading-relaxed text-sm sm:text-base text-justify"
            >
            ...
            <h1
              class="mt-12 sm:mt-24 text-3xl sm:text-4xl font-bold text-indigo-900 mb-6"
            >
              Misi
            </h1>
            <!--konten misi-->
            ...
            <ul
              class="text-gray-800 mt-4 sm:mt-6 leading-relaxed list-disc list-inside text-sm sm:text-base text-justify"
            >
              <li>
                Pellentesque habitant morbi tristique senectus et netus et
                malesuada fames ac turpis egestas. Nam accumsan non lorem vel
                eleifend. Proin viverra nisi id diam eleifend, quis rutrum
                libero sollicitudin. Duis in pulvinar ipsum, eu suscipit arcu.
              </li>
              <li>
                Pellentesque habitant morbi tristique senectus et netus et
                malesuada fames ac turpis egestas. Nam accumsan
              </li>
              <li>
                Pellentesque habitant morbi tristique senectus et netus et
                malesuada fames ac turpis egestas. Nam accumsan non lorem vel
