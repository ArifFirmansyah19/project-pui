        ...
        <div id="content" class="transition-transform duration-500 ease-in-out">
            <div class="container mx-auto">
                ...
                <form id="updateForm" action="{{ route('admin.updateMG', $dataGeopark->id) }}" method="POST"
                    ...
                    <div class="mb-4">
                        <label for="foto" class="block text-lg font-bold text-gray-700 mb-2">Gambar Utama</label>
                        ...
                        <label for="foto" class="block text-lg font-bold text-gray-700 mb-2">Unggah Foto</label>
                    ...
                    <div>
                        <label for="thumbnail" class="block text-gray-700 font-bold mb-2">Ringkasan Sejarah (Thumbnail di
                            Halaman Museum Pengunjung) Merangin</label>
