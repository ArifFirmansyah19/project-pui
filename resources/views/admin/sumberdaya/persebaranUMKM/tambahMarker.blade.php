            ...
            <form action="#" method="POST" class="space-y-4">
              ...
              <div>
                <label
                  ...
                  >Jenis Sumber Daya</label
                >
                <select
                  id="jenis"
                  name="jenis"
                  required
                  class="w-auto px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-500 focus:border-indigo-500"
                >
                  <option value="">Pilih</option>
                  <option value="UMKM">UMKM</option>
                  <option value="Potensi Alam">Potensi Alam</option>
                </select>
              </div>
              <!-- Nama -->
              <div>
                ...
                <input
                  ...
                  id="nama"
                  name="nama"
                  placeholder="Masukkan nama sumber daya"
                  required
